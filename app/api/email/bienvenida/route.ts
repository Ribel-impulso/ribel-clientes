...
export async function POST(req: Request) {
  ...
  const { error } = await resend.emails.send({
    from: 'Ribel Gestión <onboarding@resend.dev>',
    to: email,
      ...
      <div style="font-family: Arial, sans-serif; max-width: 600px; margin: 0 auto; background-color: #ffffff;">
        ...
        <div style="padding: 40px 32px; background-color: #e3dfd6;">
          ...
          <div style="text-align: center; margin: 32px 0;">
            <a href="https://ribel-clientes.vercel.app" style="background-color: #ba9a7d; color: #ffffff; padding: 14px 32px; border-radius: 8px; text-decoration: none; font-size: 16px; font-weight: bold;">
              Ir a mi cuenta
            </a>
          </div>
